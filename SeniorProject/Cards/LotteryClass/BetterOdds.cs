...
namespace SeniorProject.Cards.LotteryClass
{
    class BetterOdds : CustomCard
    {
        ...
        public override void OnAddCard(Player player, Gun gun, GunAmmo gunAmmo, CharacterData data, HealthHandler health, Gravity gravity, Block block, CharacterStatModifiers characterStats)
        {
            ...
            player.gameObject.GetComponent<LotteryPointAndCard>().blowUpS *= 2;
        ...
        {
            gameObject.GetComponent<LotteryPointAndCard>().blowUpS /= 2;
        ...
        {
            return "Half the chance to self destruct";
        }
