...
{
    class GuardiansGuardian : CustomCard
    {
        ...
        public override void OnAddCard(Player player, Gun gun, GunAmmo gunAmmo, CharacterData data, HealthHandler health, Gravity gravity, Block block, CharacterStatModifiers characterStats)
        {
            ...
            player.gameObject.GetComponent<GuardianPointAndCard>().block_cd++;
            player.gameObject.GetComponent<GuardianPointAndCard>().mSpeed -= 0.05f;
            player.gameObject.GetComponent<GuardianPointAndCard>().mGravity += 0.05f;
        ...
        public override void OnRemoveCard(Player player, Gun gun, GunAmmo gunAmmo, CharacterData data, HealthHandler health, Gravity gravity, Block block, CharacterStatModifiers characterStats)
        {
            ...
            gameObject.GetComponent<GuardianPointAndCard>().block_cd--;
            gameObject.GetComponent<GuardianPointAndCard>().mSpeed += 0.05f;
            gameObject.GetComponent<GuardianPointAndCard>().mGravity -= 0.05f;
        ...
        {
            return "The Guardians... Guardian?";
        }

        protected override string GetDescription()
        {
            return "Add some Guardian to your Guardian.";
        }
